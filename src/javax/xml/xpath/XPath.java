 ...
 * <td>variables</td>
 * <td>
 * If the expression contains a variable reference, its value will be found
 * through the {@link XPathVariableResolver}
 * set with {@link #setXPathVariableResolver(XPathVariableResolver resolver)}.
 * An {@link XPathExpressionException} is raised if the variable resolver is
 * undefined or
 * the resolver returns <code>null</code> for the variable.
 * The value of a variable must be immutable through the course of any single
 * evaluation.
 * </p>
 * </td>
 * </tr>
 ...
 * <td>functions</td>
 * <td>
 * If the expression contains a function reference, the function will be found
 * through the {@link XPathFunctionResolver}
 * set with {@link #setXPathFunctionResolver(XPathFunctionResolver resolver)}.
 * An {@link XPathExpressionException} is raised if the function resolver is
 * undefined or
 * the function resolver returns <code>null</code> for the function.
 * </p>
 * </td>
 * </tr>
 * <tr>
 ...
 * <td>result</td>
 * <td>
 * This result of evaluating an expression is converted to an instance of the
 * desired return type.
...
public interface XPath {
	 ...
	 *
	 * @throws NullPointerException If <code>nsContext</code> is
	 *             <code>null</code>.
	 */
	 ...
	 * 
	 * @throws XPathExpressionException If <code>expression</code> cannot be
	 *             compiled.
	 ...
	 * context item evaluation,
	 * variable, function and <code>QName</code> resolution and return type
	 * conversion.
	 * </p>
	 *
	 * <p>
	 ...
	 * @throws XPathExpressionException If <code>expression</code> cannot be
	 *             evaluated.
	 * @throws IllegalArgumentException If <code>returnType</code> is not one of
	 *             the types defined in {@link XPathConstants}.
	 ...
	 * <code>item</code>, an empty document will be used for the
	 * context.
	 * If <code>expression</code> is <code>null</code>, then a
	 * <code>NullPointerException</code> is thrown.
	 * </p>
	 *
	 * @param expression The XPath expression.
	 ...
	 *             <code>source</code> or <code>returnType</code>
	 *             is <code>null</code>.
	 */
