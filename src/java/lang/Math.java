...
public final class Math {
	 ...
	 * {@code floorDiv} that returns the integer less than or equal to the
	 * quotient
			...
			default:
				...
				if (exp >= FloatConsts.MIN_EXPONENT) {
					...
					return Float.intBitsToFloat(
							1 << (exp - (FloatConsts.MIN_EXPONENT - (FloatConsts.SIGNIFICAND_WIDTH - 1))));
				}
		}
	}
	 ...
	 * (<i>e<sup>x</sup>&nbsp;-&nbsp;e<sup>-x</sup></i>)/(<i>e<sup>x</sup>
	 * &nbsp;+&nbsp;e<sup>-x</sup></i>),
	...
	public static int getExponent(double d) {
		 ...
		 * get true exponent value.
		 */
		return (int) (((Double.doubleToRawLongBits(d) & DoubleConsts.EXP_BIT_MASK) >> (DoubleConsts.SIGNIFICAND_WIDTH
	...
	static double powerOfTwoD(int n) {
		...
		return Double
				.longBitsToDouble((((long) n + (long) DoubleConsts.EXP_BIAS) << (DoubleConsts.SIGNIFICAND_WIDTH - 1))
