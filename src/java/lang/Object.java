...
public class Object {
	 ...
	 * 
	 * the usual purpose of {@code finalize}, however, is to perform cleanup
	...
	//
	// As Joachim pointed out, this may never happen in the life of a program if
	// the object is always accessible.
	//
	// Also, the garbage collector is not guaranteed to run at any specific
	// time. In general, what I'm trying to say is finalize() is probably not
	// the best method to use in general unless there's something specific you
	// need it for.
